...
which not only involves the typically intractable likelihood $p(x | \\theta)$ (black box simulator), but also an intractable integral over the parameter space $\\Theta$.
