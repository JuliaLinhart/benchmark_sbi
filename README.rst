...
which not only involves the typically intractable likelihood $p(x | \\theta)$, but also an intractable integral over the parameter space $\\Theta$ (black box latent space).
